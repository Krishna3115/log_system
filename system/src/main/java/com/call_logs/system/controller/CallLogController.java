...
public class CallLogController {
	    ...
	    public ResponseEntity<?> sendBill(@PathVariable("id") Long id, @RequestBody BillRequest billRequest)
	{
	    ...
	    public List<CallLog> getPendingBills() {
	        return callLogService.getPendingBills();
	    }
	
	    // Pay a bill
	    @PutMapping("/pay-bill/{id}")
	    public CallLog payBill(@PathVariable("id") Long id, @RequestBody PaymentRequest request) {
	        return callLogService.payBill(id, request);
	    }

	
	 // Get all partially paid bills
	    @GetMapping("/partially-paid-bills")
	    public List<CallLog> getPartiallyPaidBills() {
	        return callLogService.getPartiallyPaidBills();
	    }
